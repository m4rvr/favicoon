...
export default function (): JSX.Element {
  ...
  const [previewIcon, setPreviewIcon] = createSignal<string>()
  ...
  return (
    <Switch>
      ...
      <Match when={view() === View.UploadedInfo && image()}>
      ...
      <Match when={view() === View.Preview}>
        <>
          <h3 class="mb-8 text-center font-semibold text-lg">Preview</h3>
          <div class="w-[300px] relative">
            <img
              src={previewIcon()}
              class="absolute top-[16px] left-[85px] z-5"
              width="16"
              height="16"
            />
            <img src={chromeDark} />
